...
class QICDataProcessor(object):
    def __init__(self, root):
        ...
        #****************************
        #25部门
        # self.label_list = ['白沙洲街', '华中金融城', '黄鹤楼街', '积玉桥街', '粮道街', '南湖街',
        #                    '区城市管理执法局', '区房管局', '区环保局', '区建管站', '区教育局',
        #                    '区人力资源局', '区市场监督管理局', '区水务和湖泊局', '区卫生健康局', '首义路街', '水果湖街',
        #                    '武昌公安分局', '武昌交通大队', '武昌社保处', '徐家棚街', '杨园街',
        #                    '中华路街', '中南路街', '紫阳街']
        #48部门
        self.label_list = ['白沙洲街', '滨江商务区', '湖北华电武昌热电有限公司', '黄鹤楼街', '积玉桥街',
                           '粮道街', '珞珈山街', '南湖街', '其他部门', '区城区改造更新局',
                           '区城市改造更新局', '区城市管理执法局', '区地方金融工作局', '区发展和改革局', '区法院',
                           '区房地公司', '区房管局', '区国资控股集团', '区环保局', '区建管站',
                           '区建设局', '区教育局', '区金融局', '区科学技术和经济信息化局', '区民政局',
                           '区人力资源局', '区商务局', '区市场监督管理局', '区市政公司', '区水务和湖泊局',
                           '区税务局', '区卫生健康局', '区文化和旅游局', '区行政审批局', '区站区办',
                           '石洞街', '市自然资源和规划局武昌分局', '首义路街', '水果湖街', '武昌公安分局',
                           '武昌规土分局', '武昌交通大队', '武昌社保处', '徐家棚街', '杨园街',
                           '中华路街', '中南路街', '紫阳街']
        #26案件大类
        # self.label_list = ['安全生产管理类', '承接省政务服务平台办件', '城市管理与环境保护类', '城市市容管理类', '待分类案件',
        #                    '房屋土地管理类', '公共设施维护管理', '纪检监察', '建设管理类', '交通管理类',
        #                    '教育管理类', '其它事件', '企业直通车', '三农问题', '社管事项',
        #                    '社会服务类', '社会劳动保障管理类', '社会治安管理', '食品药品及医疗卫生管理类', '市场管理类',
        #                    '突发事件', '宣传广告指示牌类', '疫情', '营商环境类', '园林绿化类',
        #                    '政务服务']
        #****************************
